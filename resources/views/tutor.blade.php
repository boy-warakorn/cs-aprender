...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top" class="container-fluid">
    ...
    <script>
        // Add active class to the current button (highlight it)c
        var header = document.getElementById("myDIV");
        var btns = header.getElementsByClassName("btn");
        for (var i = 0; i < btns.length; i++) {
            btns[i].addEventListener("click", function() {
             var current = document.getElementsByClassName(" keepstay");
             current[0].className = current[0].className.replace(" keepstay", "");
             console.log(current);
             this.className += " keepstay";
            });
        }
    </script>
    <div class="container">
